...
const Customization = () => {
  ...
  const productData = productsData.find((p) => p.id === "personalizacion")
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <img
                  src="/metodolog-a-epics-en-desarrollo-de-sensores.jpg"
                  alt="Metodología EPICS"
                  className="w-full h-32 object-cover rounded-lg"
                />
                <img
                  src="/prototipado-r-pido-de-sensores-personalizados.jpg"
                  alt="Prototipado rápido"
                  className="w-full h-32 object-cover rounded-lg"
                />
                <img
                  src="/documentaci-n-t-cnica-de-proyecto-personalizado.jpg"
