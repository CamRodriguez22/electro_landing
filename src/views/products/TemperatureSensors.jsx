...
const TemperatureSensors = () => {
  ...
  const productData = productsData.find((p) => p.id === "sensores-temperatura")
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <img
                  src="/sensor-de-temperatura-dht22-en-protoboard.jpg"
                  alt="Sensor DHT22 en protoboard"
                  className="w-full h-32 object-cover rounded-lg"
                />
                <img
                  src="/circuito-integrado-con-op-amp-para-sensor.jpg"
                  alt="Circuito con OP-AMP"
                  className="w-full h-32 object-cover rounded-lg"
                />
                <img
                  src="/pruebas-de-calibraci-n-de-sensor-de-temperatura.jpg"
                  alt="Pruebas de calibración"
