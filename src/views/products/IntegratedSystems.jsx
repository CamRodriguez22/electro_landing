...
const IntegratedSystems = () => {
  ...
  const productData = productsData.find((p) => p.id === "sistemas-integrados")
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <img
                  src="/sistema-iot-con-esp32-y-sensores.jpg"
                  alt="Sistema IoT con ESP32"
                  className="w-full h-32 object-cover rounded-lg"
                />
                <img
                  src="/dashboard-web-para-monitoreo-ambiental.jpg"
                  alt="Dashboard web"
                  className="w-full h-32 object-cover rounded-lg"
                />
                <img
                  src="/instalaci-n-del-sistema-en-sal-n-a2c.jpg"
                  alt="Instalación en salón A2C"
